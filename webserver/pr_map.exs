%{
  ...
  avg_avail: 59275,
  best_datasheet: "http://datasheet.octopart.com/1N914-ON-Semiconductor-datasheet-42765246.pdf",
  ...
  specs: [
    ...
    %{
      attribute: %{group: "Supply Chain", name: "Lifecycle Status", shortname: "lifecyclestatus"},
    ...
    %{
      attribute: %{group: "Technical", name: "Max Surge Current", shortname: "maxsurgecurrent"},
      display_value: "4 A",
      units: "A",
      value: "4"
    },
    ...
    %{
      attribute: %{group: "Technical", name: "Power Dissipation", shortname: "powerdissipation"},
      display_value: "500 mW",
      units: "mW",
      value: "500"
    },
